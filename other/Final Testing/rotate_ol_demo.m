...
% existing code
coord_cube1 = [17.5,3.5,17.5];
coord_cube2 = [17.5,3.5,-5];
coord_cube3 = [0,3.5,-17.5];
...
coord_extend1=coord_rotate1 + [-3.75,6,-10];
coord_rotate_elevate1 = coord_extend1 + [3.75,4,10];

coord_rotate2 = coord_cube2;
coord_extend2=coord_rotate2 + [-4.5,6,0];
coord_rotate_elevate2 = coord_extend2 + [4.5,4,0];

coord_rotate3 = coord_cube3;
coord_extend3=coord_rotate3 + [-4,6,4];
coord_rotate_elevate3 = coord_extend3 + [4,4,-4];
goalcoord = 0;
goalpose = 0;
gripper_pos = 0;
goalcoord_elevate=0;
