...
coord_cube3 = [0,3.5,-17.75];
coord_reset = [27.4,20.5,0];
%elevations
coord_cube1_elevate = coord_cube1 + [-3,0.8,-3];
coord_cube2_elevate = coord_cube2 + [0,4,0];
coord_cube3_elevate = coord_cube3 + [0,2,0];

%end coordinates for moving
coord_cube1_end = [0,3.0,15];
coord_cube2_end = [10,3.0,10];
coord_cube3_end = [22.5,3.0,0];
...
coord_cube2_end_elevate = coord_cube2_end + [0,3,0];
...
theta1_IK = (theta1_IK *180/pi)-1.5;
