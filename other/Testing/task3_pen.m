...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_1, 112, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_2, 112, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_3, 112, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_4, 112, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_5, 112, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_1, 108, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_2, 108, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_3, 108, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_4, 108, 30000);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_5, 108, 30000);
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_1, 112, 200);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_2, 112, 200);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_3, 112, 200);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_4, 112, 200);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_5, 112, 200);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_1, 108, 90);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_2, 108, 90);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_3, 108, 90);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_4, 108, 90);
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID_5, 108, 200);
...
while done == 0
    ...
    switch state
        ...
        case 'line 1'
            ...
            for i = 1:line_steps
                goalcoord = [line1x[i], line1y[i], draw_height];
                goalpose = pose_pickup;
                gripper_pos = gripper_close;
                move(goalcoord,goalpose,gripper_pos);
        ...
        case 'line2'
            ...
            for i = 1:line_steps
                goalcoord = [line2x[i], line2y[i], draw_height];
                goalpose = pose_pickup;
                gripper_pos = gripper_close;
