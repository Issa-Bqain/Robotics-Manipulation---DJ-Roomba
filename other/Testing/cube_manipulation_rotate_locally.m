...
%end coordinates
coord_cube1_end = [10,3.25,0];
coord_cube2_end = [12.5,3.25,12.5];
...
coord_rotate_elevate2=coord_rotate_elevate + [-4,4,4]
coord_extend = coord_rotate_elevate2 + [4,4,-4]
goalcoord = 0;
goalpose = 0;
gripper_pos = 0;
goalcoord_elevate=0;
    ...
    switch state
        ...
        case 'rotate'
            ...
            for i = 1:rotation_num
               ...
               goalcoord = coord_rotate_elevate2;
               goalpose = pose_pickup;
               move(goalcoord, goalpose,gripper_pos);
