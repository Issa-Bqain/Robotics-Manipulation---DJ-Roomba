...
% existing code
coord_cube1 = [7.5,3.85,20]+[1,0,1];
coord_cube2 = [22.5,3.85,0]+[1,0,1];
coord_cube3 = [15,3.85,-15]+[1,0,1];
...
coord_cube2_end = [10,3.0,0]+[1,0,1];
coord_cube1_end = [12.5,3.0,12.5]+[1,0,1];
coord_cube3_end = [-0.25,3.0,-10]+[1,0,1];mnmnmnt5
