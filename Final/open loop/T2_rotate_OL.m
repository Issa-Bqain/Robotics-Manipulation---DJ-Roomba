...
% existing code
coord_cube1 = [17.5,3.75,17.6];
coord_cube2 = [17.8,3.75,-5.3];
coord_cube3 = [0,3.75,-17.9];
coord_reset = [27.4,20.5,0];
%elevations
coord_cube1_elevate = coord_cube1 + [0,1.7,0];
coord_cube2_elevate = coord_cube2 + [0,3,0];
...
coord_extend1=coord_rotate1 + [-8.75,6,-8.75];
coord_rotate_elevate1 = coord_extend1 + [8.75,4,8.75];
